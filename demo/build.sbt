...
libraryDependencies ++= Seq(
  ...
  "mil.nga.giat" % "geowave-adapter-raster" % "0.9.2.1" % "provided",
  "mil.nga.giat" % "geowave-core-store" % "0.9.2.1" % "provided",
  "mil.nga.giat" % "geowave-datastore-accumulo" % "0.9.2.1" % "provided",
