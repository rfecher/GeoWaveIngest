...
java -cp /poke-jar/raster-poke-assembly-0.jar com.example.raster.RasterIngest geodocker-zookeeper gis root GisPwd gwRaster /rasters/TC_NG_Baghdad_IQ_Geo.tif
